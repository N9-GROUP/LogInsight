...
void stop_monitoring()
{
  ...
  std::cout << "│ " << reset_color << std::left << std::setw(32) << "Monitoring Statistics:" << reset_color << "│\n";
  std::cout << "├─────────────────────────────────┘ \n";

  std::cout << reset_color << "│ " << reset_color << std::left << std::setw(15) << "Elapsed time:" << border_color;
  if (elapsed < 1.0)
  {
  ...
  std::cout << reset_color << "│ " << reset_color << std::left << std::setw(15) << "Memory used:" << border_color;
  if (memory_used < 1024)
  {
  ...
  std::cout << reset_color << "│ " << reset_color << std::left << std::setw(15) << "CPU time:" << border_color;
  if (cpu_time < 1.0)
  {
